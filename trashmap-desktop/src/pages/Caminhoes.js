  ...
  async function cadastrarCaminhao() {
    try {
      const data = {
        ...
        capacidadeKg: parseFloat(formCadastro.capacidadeKg)
      };
  ...
  async function editarCaminhao() {
    try {
      const data = {
        ...
        capacidadeKg: parseFloat(formEditar.capacidadeKg)
      };
  ...
  return (
    <>
      ...
      <div className="section">
        ...
        <input name="capacidadeKg" placeholder="Capacidade Kg" value={formCadastro.capacidadeKg} onChange={(e) => handleFormChange(e, setFormCadastro)} />
      ...
      <div className="section">
        <h3>Cadastrar Vários Caminhões (JSON Array)</h3>
        <textarea 
          value={jsonLote} 
          onChange={(e) => setJsonLote(e.target.value)} 
          placeholder='[{"placa":"ABC-1234","latitude":-12.0,"longitude":-38.0,"statusCaminhao":"ATIVO","capacidadeKg":1000}]'
        ></textarea>
        <button onClick={cadastrarLote}>Cadastrar Lote</button>
        {resLote && <pre>{resLote}</pre>}
      </div>
      ...
      <div className="section">
        ...
        <input name="capacidadeKg" placeholder="Capacidade Kg" value={formEditar.capacidadeKg} onChange={(e) => handleFormChange(e, setFormEditar)} />
